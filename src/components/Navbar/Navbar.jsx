...
const Navbar = () => {
  ...
  return (
    <div className="w-screen flex flex-wrap align-middle justify-between px-10 py-6 bg-gray-100">
      <div className="logo">
      ...
      >
        ...
        >
          <NavLink exact activeClassName="navbar__link--active" to="pricelist">
            PRICELIST
          </NavLink>
        </li>
        <li
        ...
        >
          <NavLink exact activeClassName="navbar__link--active" to="contact-us">
            CONTACT US
          </NavLink>
        </li>
      </ul>
